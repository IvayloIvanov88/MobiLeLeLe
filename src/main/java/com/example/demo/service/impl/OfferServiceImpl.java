...
import com.example.demo.web.error.NotFoundObjectException;
...
public class OfferServiceImpl implements OfferService {
    ...
    public void updateOffer(OfferUpdateServiceModel serviceModel) {
        ...
        OfferEntity offer = offerRepository.findById(modelId).
                orElseThrow(() -> new NotFoundObjectException("Offer with id " + modelId + " is not found."));
    ...
    private OfferSummaryViewModel map(OfferEntity offer) {
        return modelMapper
                .map(offer, OfferSummaryViewModel.class)
